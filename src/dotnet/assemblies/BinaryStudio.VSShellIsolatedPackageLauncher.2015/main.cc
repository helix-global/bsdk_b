// BinaryStudio.VSShellIsolatedPackage2015.cpp : Defines the entry point for the application.
//
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	nRetVal = StartWithCommandLine(lpwCmdLine, L"BinaryStudio_VSShellIsolatedPackage2015", nCmdShow, NULL, NULL);
